...
# Show the plots
plt.tight_layout()
plt.savefig('images/gender_education_distribution.png')
plt.show()
...
# Show the plot
plt.tight_layout()
plt.savefig('images/top10_jobs.png')
plt.show()
...
plt.tight_layout()
plt.savefig('images/gender_education_salary.png')
plt.show()
...
plt.savefig('images/education_salary_gender.png')
plt.show()
...
plt.tight_layout()
plt.savefig('images/age_experience_salary.png')
plt.show()
